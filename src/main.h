...
static const int64 MAX_MONEY = 100000000 * COIN; // maximum of 100000000 coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 8400 / 250; // 5760 blocks found a day (4 blocs/min * 60min/hr * 24hr/day)./L. Priority cutoff is 1 LRC day / 250 bytes.
    }
